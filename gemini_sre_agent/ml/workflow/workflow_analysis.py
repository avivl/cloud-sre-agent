...
class WorkflowAnalysisEngine(ProcessableComponent[Dict[str, Any], AnalysisResult]):
    ...
    def __init__(
        ...
        self.analysis_agent = EnhancedAnalysisAgent(
            ...
            agent_name="workflow_analysis_agent"
        )
    ...
    def get_analysis_metrics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "success_rate": (self.successful_analyses / self.analysis_count * 100) if self.analysis_count > 0 else 0.0,
            "total_analysis_time": self.total_analysis_time,
            "average_analysis_time": (self.total_analysis_time / self.analysis_count) if self.analysis_count > 0 else 0.0,
        }
    ...
    def check_health(self) -> bool:
        ...
        return (
            ...
            self.failed_analyses < self.successful_analyses  # More successes than failures
        )
