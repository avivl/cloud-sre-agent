...
class ChatModel(LLMModel[RequestT, ResponseT]):
    ...
    @abstractmethod
    def chat_completion_stream(self, messages: List[Dict[str, Any]], **kwargs: Any) -> AsyncIterator[ResponseT]:
        """
...
class LLMManager(MonitorableComponent[RequestT, ResponseT]):
    ...
    @abstractmethod
    def route_request(self, request: RequestT, preferred_model: Optional[ModelId] = None) -> ResponseT:
        """
